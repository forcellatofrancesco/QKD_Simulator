...
def getSelectedNodeMenu(values, templates):
    ...
    out.append(
        getDropdownField(
            values["type"], OPTIONS, "Node Type:", "selected_node_type", "type"
        )
    )
    out.append(
        getDropdownField(
...
def getSelectedEdgeMenu(values, nodes, link_types):
    return dbc.Form(
        [
            ...
            getInputField(
                values["distance"], "Distance:", "selected_distance", "distance"
            ),
        ]
    )
...
classic_edge = [
    getInputField("", "Distance:", "distance_input", ""),
    getInputField("", "Attenuation:", "attenuation_input", ""),
]
...
bsm_template = [
    ...
    dcc.Dropdown(id="detec_type", className="detector_type", value="", options=[]),
]
...
add_node_form = html.Div(
    dbc.Form(
        [
            ...
            getDropdownField("Quantum_Router", OPTIONS, "Type:", "type_menu", ""),
            getDropdownField(
                "",
                [],
                "Template:",
...
make_new_template = html.Div(
    dbc.Form(
        [
            ...
            getDropdownField(
                "Quantum_Router", OPTIONS, "Type:", "template_type_menu", ""
            ),
